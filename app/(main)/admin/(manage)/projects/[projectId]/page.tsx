...
const ManageProject = ({
  ...
  return (
    <div className="relative min-h-0 w-full flex-1 flex flex-col">
      <div className="h-[25vh] w-full flex flex-col pt-16 border-b border-zinc-300 from-[#e7e7eb] to-[#f0f2ff] bg-gradient-to-br dark:border-border dark:bg-none dark:bg-background">
        <div className="w-full max-w-6xl ml-16 2xl:mx-auto space-y-2">
          ...
          >
            {project?.name ? (
              ...
              <Skeleton className="w-[146px] h-[25px] bg-slate-300 dark:bg-accent" />
            )}
          </motion.h1>
        ...
        <div className="mt-auto flex flex-row gap-4 text-slate-700 w-full max-w-6xl ml-16 2xl:mx-auto dark:text-foreground">
          {tabs.map((t, i) => (
            <div
              key={i}
              className={cn(
